            ...
            <div className='p-2'>
                <div className='flex items-center justify-between mx-auto max-w-7xl h-16'>
                    <div className='flex items-center justify-center'>
                        ...
                        <h1 className='ml-2 text-2xl font-bold'>Job <span className='text-[#087658]'>Partner</span></h1>
                    </div>
                        ...
                        </ul>
                        {
                            !user ? (
                                <div className='flex items-center gap-2'>
                                    ...
                                    <Link to="/signup"><Button className="bg-[#087658] hover:bg-[#08761d]">Signup</Button></Link>
                                </div>
                            ) : (
                                <Popover>
