...
const UpdateProfileDialog = ({ open, setOpen }) => {
    ...
    const [input, setInput] = useState({
        ...
        skills: user?.profile?.skills?.join(", ") || "",  // Ensure skills are formatted as comma-separated string
    });
    ...
    const addExperience = () => {
        setExperiences([...experiences, { company: '', startDate: '', endDate: '', position: '' }]);
    };
    ...
    const addEducation = () => {
        setEducations([...educations, { university: '', startYear: '', endYear: '', major: '' }]);
    };
    ...
    const submitHandler = async (e) => {
        ...
        const dataToSubmit = {
            ...
            bio: input.bio,
            skills: input.skills.split(",").map(skill => skill.trim()),  // Clean up skills array
            experiences,  // Data for experiences
            educations,   // Data for educations
        };
