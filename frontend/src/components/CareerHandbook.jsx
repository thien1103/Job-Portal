...
const featuredArticles = [
  {
    ...
    image:
      "https://img.cake.me/cdn-cgi/image/fit=scale-down,format=auto,w=1920/https://images.cakeresume.com/images/006e1765-366d-47d1-9981-d0672da38c1c.png", // Add image URL here
  },
  {
    ...
    image:
      "https://careerconfidential.com/wp-content/uploads/2017/02/Acuity-Interview-Preparation-Infographic-Copy.jpg", // Add image URL here
  },
  {
    ...
    image:
      "https://agencyvn.com/wp-content/uploads/2022/07/hinh-anh-tuyen-dung-2.jpg", // Add image URL here
  },
  {
    ...
    image:
      "https://media.licdn.com/dms/image/v2/D4E12AQHyfHDfceV5vA/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1683055110420?e=2147483647&v=beta&t=_IZBYpagKwdKpQKE61Yw_GIEPCr3RXGEBLYqiBx8EDo", // Add image URL here
  },
];
...
const careerGuidance = [
  {
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRr3J5KO6PLfSyZWPfy489PW70XfdcdT6QHBg&s", // Add image URL here
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dz209s6jk/image/upload/f_auto,q_auto/Admin/ololguxrhts7agxrzvuy.jpg", // Add image URL here
  },
  {
    ...
    image:
      "https://mangools.com/blog/wp-content/uploads/2021/05/The-Keyword-Tripod-Rule.png", // Add image URL here
  },
  {
    ...
    image:
      "https://outreachmonks.com/wp-content/uploads/2023/04/Keyword-Research-Tips-2.jpg.webp", // Add image URL here
  },
  {
    title: "Keyword Tips",
    description:
      "Empower your keyword finding skill by tips and tricks from professionals.",
    ...
    image:
      "https://cdn.prod.website-files.com/64baacfcb337b7364622226f/64fa37c1e3220872b6058075_Keyword%20Research%20Tips.png", // Add image URL here
  },
];
...
const industryKnowledge = [
  {
    ...
    image:
      "https://storage.timviec365.vn/timviec365/pictures/images_12_2021/kien-thuc-chuyen-mon.jpg", // Add image URL here
  },
  {
    title: "Industry Guided For Begineers",
    description:
      "Here we will give you the best guidebook for your future career.",
    link: "https://huongnghiep.hocmai.vn/1-chuyen-nganh-la-gi-tranh-cam-bay-ve-nganh-va-chuyen-nganh-trong-tuyen-sinh/",
    createdDate: "27/02/2025",
    image:
      "https://huongnghiep.hocmai.vn/wp-content/uploads/2021/11/Ng%C3%A0nh-.jpg", // Add image URL here
  },
];
  ...
  const renderCarouselSection = (title, data, currentIndex, setIndex) => (
    <section className="my-10">
      ...
      <div className="relative">
        <div className="flex overflow-hidden gap-6">
          {data
            ...
            .map((item, index) => (
              <div
                key={index}
                className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between transition-transform transform hover:scale-105 min-w-[30%]"
              >
                <img
                  src={item.image}
                  alt={item.title}
        ...
        <button
          onClick={() =>
            setIndex((prev) => Math.min(data.length - itemsPerPage, prev + 1))
          }
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="absolute inset-0 bg-opacity-50 flex flex-col justify-center items-center px-4 translate-x-2">
            ...
            <p className="text-green max-w-3xl mx-auto text-base text-green-900 md:text-lg">
              Explore useful information related to your desired profession.
              Share experiences and expertise to help you find a suitable job
