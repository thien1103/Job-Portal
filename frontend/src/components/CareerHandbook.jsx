    ...
    <div className="absolute inset-0 bg-opacity-50 flex flex-col justify-center items-center px-4 translate-x-2">
      ...
      <p className="text-green max-w-3xl mx-auto text-base text-green-900 md:text-lg">
        ...
        <div className='max-w-7xl mx-auto my-10 px-4'>
          ...
          {renderCarouselSection("Bài viết nổi bật", featuredArticles, featuredIndex, setFeaturedIndex)}
          {renderCarouselSection("Định hướng nghề nghiệp", careerGuidance, guidanceIndex, setGuidanceIndex)}
          {renderCarouselSection("Kiến thức chuyên ngành", industryKnowledge, industryIndex, setIndustryIndex)}
        </div>
      </div>
    );
  };
